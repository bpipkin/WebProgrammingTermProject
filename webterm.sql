...
--
-- Host: 127.0.0.1    Database: webterm
-- ------------------------------------------------------
...
CREATE TABLE `playlist` (
  ...
  PRIMARY KEY (`name`),
  KEY `ownerName_idx` (`ownername`),
  CONSTRAINT `ownerName` FOREIGN KEY (`ownername`) REFERENCES `user` (`username`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `track` (
  ...
  `pos` int(11) NOT NULL,
  PRIMARY KEY (`sid`,`pname`,`powner`,`pos`),
...
-- Dump completed on 2015-04-19 23:19:41
